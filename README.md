...
- *RMW_UXRCE_MAX_PUBLISHERS*: This value sets the maximum number of publishers for a node.
- *RMW_UXRCE_MAX_SUBSCRIPTIONS*: This value sets the maximum number of subscriptions for a node.
